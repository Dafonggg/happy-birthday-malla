...
// Tambahan kontrol volume dan mute
window.addEventListener("DOMContentLoaded", function () {
  const music = document.getElementById("background-music");
...
// Sinkronisasi narasi dan musik
function handleNarasi(narasiId) {
  const narasi = document.getElementById(narasiId);
  const bgm = document.getElementById("background-music");

  if (!narasi) return;

  narasi.addEventListener("play", () => {
    bgm.muted = true;
  });
...
handleNarasi("narasi1");
handleNarasi("narasi2");

const second = 1000,
  minute = second * 60,
  hour = minute * 60,
  day = hour * 24;
let countDown = new Date("June 09, 2025 00:00:00").getTime(),
...
new TypeIt("#teks1", {
  strings: [
    "Makasih udah bertahan sejauh ini ya sama aku, walaupun akhir-akhir ini berat buat kita.",
    "Semoga Kita bisa kayak dulu lagi ya hhhee aamiinn.",
    "Semoga walaupun saaat ini aku tidak disamping kamu bahagia teruuss tersenyum teruss ya.",
    "Kuranginn Begadang, Kurangin Galauu dan Makan yang banyak alright?",
    "Maaf selalu kecewain, bikin kamu sakit hati, bikin kamu nangis terus, alhamdulillah di tahun ini aku masih bisa rayain Birthday kamuu.",
  ],
  startDelay: 4000,
  speed: 75,
...
new TypeIt("#teks2", {
  strings: [
    "Dengan ataupun tanpaku, Kamu harus bahagia teruss yaaa hiihiii.",
    "Meskipun sekarang kita udah nggak sama-sama lagi, aku tetap berharap yang terbaik buat kamu—bahagia, sehat, dan dikelilingi orang-orang yang sayang sama kamu.",
    "Tapi kalau suatu hari kamu ngerasa rindu seperti aku merindukanmu…",
    "Aku masih di sini. Masih ingin jadi orang yang bisa kamu peluk dulu pertama kali pas ulang tahun.",
    "",
